...
const experienceData = [
    {
        ...
        description: [
            ...
            'Utilisation de technologies variées (HTML, CSS, JavaScript, React, Next.JS, Python/Django, Java/Spring Boot, C#) pour des solutions robustes et évolutives.',
            'Collaboration avec les clients pour adapter les solutions à leurs besoins spécifiques.',
        ],
    },
    {
        title: 'Stagiaire Développement, Community Management & Création de contenus',
        company: 'Global Corporation Group SARL',
        date: 'Novembre 2024 - Février 2025',
        location: 'Yaoundé, Cameroun',
        description: [
            'Analyse des besoins métiers des utilisateurs internes et traduction en solutions informatiques adaptées',
            'Conception et développement d’un système interne de gestion pour l’organisation des données et des processus',
            'Participation à la structuration et à la sécurisation des données applicatives',
            'Rédaction de spécifications fonctionnelles et techniques',
            'Appui technique aux utilisateurs et amélioration continue des outils numériques internes',
            'Animation des pages de réseaux sociaux',
            'Création de contenus digitaux (textes, images, vidéos) pour la communication',
        ],
    },
    {
        title: 'Stagiaire Réseaux et Maintenance Informatique',
        company: 'Académie Cisco – ENSP de Yaoundé',
        date: 'Mai - Juin 2023',
        location: 'Yaoundé, Cameroun',
        description: [
            'Installation, configuration et maintenance de réseaux locaux (LAN)',
            ...
            'Initiation aux principes de cybersécurité et aux bonnes pratiques de protection des systèmes',
            'Surveillance basique des réseaux et sensibilisation aux risques informatiques',
        ],
    },
    {
        title: 'Stagiaire Développement et Communication',
        company: 'e-ROBOT Entreprise',
        date: 'Juin - Septembre 2021',
        location: 'Yaoundé, Cameroun',
        description: [
            'Participation à l’analyse des besoins et à la rédaction de cahiers des charges techniques',
            'Conception de modèles de données pour des applications informatiques',
            'Développement d’interfaces web fonctionnelles et orientées utilisateurs',
            'Contribution à la structuration et à l’organisation des contenus numériques',
            'Collaboration avec les équipes techniques et non techniques dans un cadre projet',
            'Animation des pages de réseaux sociaux',
            'Création de contenus digitaux (textes, images, vidéos) pour la communication',
        ],
    },
